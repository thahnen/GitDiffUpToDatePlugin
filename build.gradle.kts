/// build.gradle.kts (GitDiffUpToDatePlugin):
/// ========================================
///
...
pluginBundle {
    website = "https://github.com/thahnen/GitDiffUpToDatePlugin"
    vcsUrl  = "https://github.com/thahnen/GitDiffUpToDatePlugin.git"
    tags    = listOf("up-to-date", "git diff", "Gradle tasks")
}
